...
final class GlobalDefinitions {
    ...
    static let apiKey = "rJWkkAZ7vUNVNqpo"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "oEoXlqtkstZKKcpo"

    static let applicationTag = "EXAM_ATI_TEAS"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/asvab-practice-test-2022/id1561487785"
    static let appleAppID = "1556998922"
