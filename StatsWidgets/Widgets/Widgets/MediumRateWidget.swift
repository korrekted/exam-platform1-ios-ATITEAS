            ...
            VStack(alignment: .leading) {
                VStack(alignment: .center) {
                    PassRateView(title: "Widgets.PassRate".localized,
                                 ...
                                 titleColor: Color(red: 248 / 255, green: 205 / 255, blue: 70 / 255),
                    ...
                    HStack() {
                        MediumVerticalRateView(count: entry.testsTakenNum,
                                               ...
                                               color: Color(red: 248 / 255, green: 205 / 255, blue: 70 / 255))
                        Spacer()
                        ...
                        MediumVerticalRateView(count: entry.answeredQuestions,
                                               ...
                                               color: Color(red: 117 / 255, green: 204 / 255, blue: 144 / 255))
                    }
                }
                .padding(16)
            }
